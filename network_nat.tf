...
resource "aws_iam_role" "ec2_instance_policy" {
  name = "esgi_cloud_default_ec2_instance_policy"
...
resource "aws_iam_policy_attachment" "ec2_instance_policy" {
  name  = "esgi_cloud_default_ec2_instance_policy"
  roles = [aws_iam_role.ec2_instance_policy.name]
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}

resource "aws_iam_instance_profile" "ssm_instance_profile_tf" {
  name = "esgi_cloud_ssm_instance_profile"
  role = aws_iam_role.ec2_instance_policy.name
}
